from rnn_lstm.experiments import hidden_size_exp, optimizers_exp, seq_len_exp
import argparse
from rnn_lstm.settings import DEFAULT_DATASET, DEFAULT_EXPERIMENTS_DIR
...
def execute():
    ...
    parser.add_argument('--output', default=DEFAULT_EXPERIMENTS_DIR,
